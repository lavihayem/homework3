...
cout<<"\n\n The Average of class is    "<<totalAverage/counterSum<<finalAverage;
     //*******************************************************************
    ...
    printRecord( name, test1,test2, finalTest,semesterAverage,finalGrade,finalAverage,minGrade,maxGrade);
